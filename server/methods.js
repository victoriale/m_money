...
Meteor.methods({
  ...
  GetSuggestion: function(searchString,currentTime){
    var stringURL = 'http://apifin.synapsys.us/call_controller.php?action=search&option=batch&param=' + searchString + '&wild=1';
    var future = new Future();
  ...
  GetDirectoryData: function(pageNum, type, query){
    if(query === null){
      ...
      var URLString = 'http://apifin.investkit.com/call_controller.php?action=global_page&option=directory&page=' + pageNum + '&type=' + type + '&letter=' + query;
    }
