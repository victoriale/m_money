...
/*********STANDALONE PAGES**************/
  ...
  this.route('content.balancesheet',{
    path: '/:partner_id?/company/:company_id/balance-sheet',
    controller: 'BalanceSheetController'
  })

  this.route('content.incomestatement',{
    path: '/:partner_id?/company/:company_id/income-statement',
  ...
  this.route('content.cashflow',{
    path: '/:partner_id?/company/:company_id/cashflow',
...
CompanyProfileController = BaseController.extend({
 onBeforeAction: function(){
   ...
   if ( typeof Session.get('IsFirstRun') == "undefined" ) {
     ...
     path:'/:partner_id?/company/:company_id/:c_name',
...
BalanceSheetController = FinancialBaseController.extend({
 onBeforeAction: function(){
   console.log("PARTNER",this.params.partner_id);
