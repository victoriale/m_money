...
Router.map(function(){
 ...
 this.route('content.executiveprofile',{
   path:'/:lname-:fname/:ticker/executive/:exec_id',
 ...
 /*********LIST PAGES**************/
  this.route('content.toplist',{ // CHANGED
    path: '/:loc_id?/:l_name/:list_id/list',
    controller: 'TopListController'
  })

  this.route('content.sector',{ // CHANGED
    path: '/:loc_id/sector/:sector_id',
    // path: '/:partner_id?/location/:loc_id/sector/:sector_id',
    controller: 'SectorController'
  })

  this.route('content.boardcommittee',{ // CHANGED
    path: '/:ticker/:name/board/:company_id',
  ...
  this.route('content.articlenews',{ // CHANGED
...
DirectoryController = BaseController.extend({
  onBeforeAction: function(){
    if( typeof Session.get('IsFirstRun') === 'undefined'){
      ...
      if(typeof this.params.query !== 'undefined' && this.params.query.sort !== 'undefined'){
        var query = this.params.query.sort;
      }else{
        var query = null;
      }
