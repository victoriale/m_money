...
if (Meteor.absoluteUrl().indexOf("localhost") > -1 ) {
  apiUrl = "http://dev-finance-api.synapsys.us:280/call_controller.php";
} else if ( Meteor.absoluteUrl().indexOf("dev.") > -1) {
  apiUrl = "http://dev-finance-api.synapsys.us:280/call_controller.php";
} else if ( Meteor.absoluteUrl().indexOf("qa.") > -1) {
  apiUrl = "http://qa-finance-api.synapsys.us:280/call_controller.php";
} else if ( Meteor.absoluteUrl().indexOf("sandbox.") > -1) {
  apiUrl = "http://sandbox-finance-api.synapsys.us:280/call_controller.php";
} else {
